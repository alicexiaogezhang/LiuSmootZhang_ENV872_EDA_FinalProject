...
```{r}
write.csv(state_rankings_df_merge, file = "~/LiuSmootZhang_ENV872_EDA_FinalProject/data_processed/state rankings_raw.csv",
          row.names = FALSE)
```
...
```{r}
# read in raw data
state_ranking <- read.csv('~/LiuSmootZhang_ENV872_EDA_FinalProject/data_processed/state rankings_raw.csv', header = TRUE)
