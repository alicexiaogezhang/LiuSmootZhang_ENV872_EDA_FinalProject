...
party
```
Based on the T-test result, the clean energy adoption rate for Red and Blue states are different. The p-value for the test is 0.2857 (>0.05) so we fail to reject the null hypothesis of equality. The boxplots below verify the t-test result. 
